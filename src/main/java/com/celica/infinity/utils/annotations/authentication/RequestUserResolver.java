package com.celica.infinity.utils.annotations.authentication;
...
public class RequestUserResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(
        ...
        if (authentication != null && authentication.isAuthenticated()){
            return ((User) authentication.getPrincipal()).getLoggedInUser();
        }
        throw new BadRequestException("Unauthenticated user", "User is not authenticated");
    }
}
